...
dataset_path = r"C:\Users\Koteswara Rao\Desktop\All Projects\Long Term Project\dataset"
splitfolders.ratio(dataset_path, output="output", seed=1337, ratio=(0.8, 0.2))
